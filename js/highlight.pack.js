...
var hljs = (function() {
  ...
  var y = Object.freeze({
    ...
    R = "of and for in not or if then".split(" ");
  function k(e) {
    function n(n, t) {
      return RegExp(
        u(n),
    ...
    return (function t(s, o) {
      ...
      return (
        ...
        o &&
          (s.beginKeywords &&
            ((s.begin =
              "\\b(" + s.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)"),
            (s.__beforeBegin = i)),
          s.begin || (s.begin = /\B|\b/),
          (l.beginRe = n(s.begin)),
  ...
  function O(e, n) {
    return n
      ? Number(n)
      : (function(e) {
          return R.includes(e.toLowerCase());
        })(e)
      ? 0
      : 1;
  }
  ...
  return (function(t) {
    ...
    const g = { disableAutodetect: !0, name: "Plain text", contains: [] };
    var d = {
    ...
    function p(e, t, r, i) {
      ...
      function c() {
        null != y.subLanguage
          ? (function() {
              if ("" !== O) {
                ...
                if ("string" == typeof y.subLanguage) {
                  ...
                  (e = p(y.subLanguage, O, !0, R[y.subLanguage])),
          ...
          : (function() {
              if (!y.keywords) return void M.addText(O);
              let e = 0;
              y.keywordPatternRe.lastIndex = 0;
              let n = y.keywordPatternRe.exec(O),
                t = "";
              for (; n; ) {
      ...
      function b(e) {
        ...
        a.skip
          ? (O += n)
          : (a.returnEnd || a.excludeEnd || (O += n),
            c(),
            a.excludeEnd && (O = n));
        do {
          y.className && M.closeNode(),
            y.skip || y.subLanguage || (L += y.relevance),
            (y = y.parent);
        } while (y !== r.parent);
        return (
          r.starts &&
            (r.endSameAsBegin && (r.starts.endRe = r.endRe), g(r.starts)),
          ...
          return (function(e) {
            ...
            return (
              ...
              r.skip
                ...
                : (r.excludeBegin && (O += t),
                  c(),
                  r.returnBegin || r.excludeBegin || (O = t)),
              g(r),
      ...
      var _ = E(e);
      if (!_)
        throw (console.error(u.replace("{}", e)),
      ...
      try {
        for (y.matcher.considerAll(); ; ) {
          T++,
            ...
            (y.matcher.lastIndex = j);
          const e = y.matcher.exec(s);
          if (!e) break;
          const n = x(s.substring(j, e.index), e);
          j = e.index + n;
        }
        return (
          x(s.substr(j)),
    ...
    function v(e) {
      ...
      if (h(t)) return;
      N("before:highlightBlock", { block: e, language: t }),
        d.useBR
      ...
      if (s.length) {
        ...
        (e.innerHTML = a.value), (a.value = A(s, S(e), r));
      }
      (a.value = b(a.value)),
        N("after:highlightBlock", { block: e, result: a }),
        (e.innerHTML = a.value),
    ...
    Object.assign(t, {
      ...
      (t.versionString = "10.3.1");
    for (const n in y) "object" == typeof y[n] && e(y[n]);
